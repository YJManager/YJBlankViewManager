...
//  YJBlankView
//
//  Created by YJHou on 16/10/14.
//  Copyright © 2016年 YJHou. All rights reserved.
//

#import "YJMainViewController.h"
#import "YJBlankViewManager.h"
...
- (UITableView *)tableView{
    if (_tableView == nil) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, YJSCREENWIDTH, YJSCREENHEIGHT) style:UITableViewStylePlain];
